...
class UserModel extends Model
{
    ...
    protected $allowedFields = [
      'Id', 'Login', 'HashedPassword', 'Email', 'RoleId', 'LastAuthenticationToken'
    ];

    public function findByLogin(string $login): ?User {
        $builder = $this->builder($this->table);
        $response = $builder->where('Login', $login)
            ->select('Users.Id, Users.Login, Users.HashedPassword, Users.Email, Users.LastAuthenticationToken, Roles.Name as RoleName')
    ...
    {
        $builder = $this->builder($this->table);
        $query = $builder->select('Users.Id, Users.Login, Users.HashedPassword, Users.Email, Users.LastAuthenticationToken, Roles.Name as RoleName')
            ->join('Roles', 'Roles.Id = Users.RoleId');
