...
class Account extends BaseController
{
    ...
    public function postLogin()
    {
        ...
        try {
            ...
            if ($userManager->verifyAndSignInUser($login, $password, $this->response))
                return redirect()->to('book/list')->withCookies();
            else
        ...
        return redirect()->to('account/login')->with('errors', $data['errors'])->withCookies();
    }
    ...
    public function postRegister() {
        ...
        if ($errorMessage = $validator->validateSoft()) {
            ...
            return redirect()->to('account/register')->with('errors', $data['errors']);
        } else {
            try {
                $userManager = Services::userManager();
                ...
                return redirect()->to('account/register')->with('errors', $data['errors'])->withCookies();
